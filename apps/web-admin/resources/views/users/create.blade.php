...
<div class="max-w-3xl mx-auto space-y-5">
    ...
    <div>
        ...
        <p class="text-sm text-gray-500 mt-0.5">Completá los datos para registrar un nuevo usuario en la plataforma</p>
    </div>
    ...
    <form method="POST" action="{{ route('users.store') }}" class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="last_name" value="{{ old('last_name') }}" required
                        class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 @error('last_name') border-red-400 @enderror">
                ...
                <div>
                    ...
                    <input type="tel" name="phone" value="{{ old('phone') }}" placeholder="+54 9 11 1234-5678"
                ...
                <div>
                    ...
                    <input type="text" name="dni" value="{{ old('dni') }}" placeholder="12345678" required
                        class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 @error('dni') border-red-400 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="cuit" value="{{ old('cuit') }}" placeholder="20-12345678-9"
                        class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <select name="role" required class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 bg-white">
                        <option value="">Seleccionar rol</option>
                        <option value="ADMIN" {{ old('role') === 'ADMIN' ? 'selected' : '' }}>Admin</option>
                        <option value="AFFILIATE" {{ old('role') === 'AFFILIATE' ? 'selected' : '' }}>Afiliado</option>
                        <option value="MERCHANT" {{ old('role') === 'MERCHANT' ? 'selected' : '' }}>Comerciante</option>
                ...
                <div>
                    ...
                    <input type="text" name="employer_cuit" value="{{ old('employer_cuit') }}" placeholder="30-12345678-9"
                        class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="affiliation_date" value="{{ old('affiliation_date') }}"
                        class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500">
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end gap-3">
            <a href="{{ route('users.index') }}" class="px-5 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                Cancelar
            </a>
            <button type="submit" class="px-6 py-2 text-sm font-semibold text-white rounded-lg hover:opacity-90 transition-opacity" style="background-color: #00A89D;">
                Guardar Usuario
            </button>
        </div>
    </form>
